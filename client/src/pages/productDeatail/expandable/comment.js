          ...
          {content && content.length > 0 ? (
            <>
              <div
                ...
                className="w-full md:flex block items-center p-4 "
              >
                ...
                <div className="flex justify-center text-center gap-2 mx-2">
                  <Button
                    ...
                    className="border-[1px] border-solid border-gray-300 py-1 px-2 md:px-4 mx-2"
                  >
                  ...
                  {[5, 4, 3, 2, 1].map((star) => (
                    <Button
                      ...
                      className="border-[1px] border-solid border-gray-300 py-0 px-2 md:px-4"
                    >
                      <span>{star}</span> Sao (
              ...
              <div className="my-2 md:flex block md:mx-0 mt-4 mx-4">
                <div className="w-full cursor-pointer relative max-w-xl ">
                  ...
                  />
                  <span
                    style={{ right: "2%", transform: "translateY(-50%)" }}
              ...
              <section className="relative flex items-center justify-center antialiased min-w-screen md:mx-0 mt-4 mx-4">
